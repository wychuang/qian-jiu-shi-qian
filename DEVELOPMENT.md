...
- `knowledge-course/`: course archive generated by the local `knowledge-course` skill. It stores lecture, discussion, thinking, homework, and synthesis records for product-design learning; it is documentation only and is not deployed to Pages.
